package lt.eif.viko.l.mackevicius.bookstore.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema orderSchema){
        ...
        wsdl11Definition.setPortTypeName("ServiceInitialize");
    ...
    public XsdSchema orderSchema(){
        return new SimpleXsdSchema(new ClassPathResource("bookorders.xsd"));
    }
}
